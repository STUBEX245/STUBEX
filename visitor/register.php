...
<body>
				<header class="header">
            <a href="#" class="logo"><img src="../images/logo/logo01.png" height="50px" alt=""></a>
				...
				<div class="form-right">
					...
					<div class="form-group">
						<div class="form-row form-row-1">
							<input type="text" pattern="[0-9]{5}" name="zip" value="<?php echo $_POST['zip']; ?>" class="zip" id="zip" placeholder="Post Code" required>
						</div>
						<div class="form-row form-row-2">
							<input type="text" name="state" value="<?php echo $_POST['state']; ?>" class="state" id="state" placeholder="City" required>
						</div>
					</div>
					<div class="form-row">
                    <input type="text" name="area" value="<?php echo $_POST['area']; ?>" class="area" id="area" placeholder="State" required>
					</div>
					<div class="form-row">
