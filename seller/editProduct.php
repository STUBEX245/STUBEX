...
<head>
    ...
    <link rel="icon" href="../images/logo/icon01.png" sizes="32x32" type="image/png" sizes="50x50">
...
<header class="header">
            <a href="../seller/sellerMain.php" class="logo"><img src="../images/logo/logo1.png" height="50px" alt=""></a>
