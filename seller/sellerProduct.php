...
<body style="background:#edf0f2;">
        <header class="header">
            <a href="../seller/sellerMain.php" class="logo" style="margin-top:-10px;"><img src="../images/logo/logo01.png" height="50px" alt=""></a>
					...
					<tbody>
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								include('../seller/editquantity_onoffshelf_modal.php');
							}
						?>
					</tbody>
				</table>
