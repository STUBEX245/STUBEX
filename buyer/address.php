...
<header class="header">
            <a href="../buyer/buyerMain.php" class="logo" style="margin-top:-10px;"><img src="../images/logo/logo01.png" height="50px" alt=""></a>
      ...
      <div class="row">
        ...
        <a href="#buyerProfile.php" data-toggle="modal" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span> Add</a>
      </div>
			<div class="height10">
			</div>
			<div class="row">
